...
public class AutonomousDistance extends SequentialCommandGroup {
   ...
   */
  /* [INFO 1A] There are many command groups. When we use sequencial command groups, one command runs
  ...
  public AutonomousDistance(Drivetrain drivetrain) {
    /* [Info 1B] Always write the addCommands(); function and inside each command
